            ...
            <div className="border-t pt-4">
              <div className="flex items-center gap-2 mb-2">
                <Avatar className="h-6 w-6">
                  <AvatarFallback className="text-xs">{ticket.messages[0].sender.name.charAt(0)}</AvatarFallback>
                </Avatar>
                <span className="text-sm font-medium">{ticket.messages[0].sender.name}</span>
                <span className="text-xs text-gray-500">{getTimeAgo(new Date(ticket.messages[0].createdAt))}</span>
              </div>
              <p className="text-sm text-gray-600 line-clamp-2">{ticket.messages[0].content}</p>
            </div>
          )}
