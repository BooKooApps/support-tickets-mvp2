...
export function ReviewDialog({ open, onOpenChange, ticketId, ticketTitle }: ReviewDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>How was your experience with "{ticketTitle}"?</DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-3">
            ...
            {rating > 0 && (
              <p className="text-sm text-gray-600">
                ...
                {rating === 2 && "We appreciate your feedback and will do better."}
